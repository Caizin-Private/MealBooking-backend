...
//
//    private final AzureOAuth2UserFilter azureOAuth2UserFilter;
//
...
//                        .requestMatchers("/api/auth/**", "/actuator/health", "/swagger-ui/**", "/v3/api-docs/**", "/api/test/**", "/api/location/**", "/api/email/**", "/api/scheduler/**", "/api/ses-test/**", "/api/region-test/**").permitAll()
